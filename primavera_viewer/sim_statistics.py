...
def annual_mean(cube):
    print('getting annual mean '+cube.coord('experiment_label').points[0])
...
def monthly_analysis(cube):
    print('getting monthly mean '+cube.coord('experiment_label').points[0])
    cube = format.add_extra_time_coords(cube)
...
def daily_anomaly(cube):
    print('getting daily anomaly '+cube.coord('experiment_label').points[0])
