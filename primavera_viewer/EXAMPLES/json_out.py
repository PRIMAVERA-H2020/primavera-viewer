...
app_config = {
    ...
    '.tasmax': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','MOHC','HadGEM3-GC31-LM',
                         'highresSST-present','r1i1p1f1','day','tasmax','gn',
                         'v20180605')
    },
    ...
    '.tasmax': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','MOHC','HadGEM3-GC31-LM',
                         'highresSST-present','r1i2p1f1','day','tasmax','gn',
                         'v20180605')
    },
    ...
    '.tasmax': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','MOHC','HadGEM3-GC31-LM',
                         'highresSST-present','r1i3p1f1','day','tasmax','gn',
                         'v20180605')
    },
    'CMIP6.HighResMIP.MOHC.HadGEM3-GC31-LM.highresSST-present.r1i1p1f1.day'
    '.tasmin': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','MOHC','HadGEM3-GC31-LM',
                         'highresSST-present','r1i1p1f1','day','tasmin','gn',
                         'v20180605')
    },
    'CMIP6.HighResMIP.MOHC.HadGEM3-GC31-LM.highresSST-present.r1i2p1f1.day'
    '.tasmin': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','MOHC','HadGEM3-GC31-LM',
                         'highresSST-present','r1i2p1f1','day','tasmin','gn',
                         'v20180605')
    },
    'CMIP6.HighResMIP.MOHC.HadGEM3-GC31-LM.highresSST-present.r1i3p1f1.day'
    '.tasmin': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','MOHC','HadGEM3-GC31-LM',
                         'highresSST-present','r1i3p1f1','day','tasmin','gn',
                         'v20180605')
    },
    ...
    '.tasmax': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','MOHC','HadGEM3-GC31-MM',
                         'highresSST-present','r1i1p1f1','day','tasmax','gn',
                         'v20170808')
    },
    ...
    '.tasmax': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','MOHC','HadGEM3-GC31-HM',
                         'highresSST-present','r1i1p1f1','day','tasmax','gn',
                         'v20170831')
    },
    ...
    '.day.tasmax': {
        'directory':
            os.path.join('/scratch/prutter/primavera/stream1','CMIP6',
                         'HighResMIP','EC-Earth-Consortium','EC-Earth3',
                         'highresSST-present','r1i1p1f1','day','tasmax','gr',
                         'v20170911')
    },
